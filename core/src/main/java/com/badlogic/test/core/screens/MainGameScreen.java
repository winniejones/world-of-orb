...
import com.badlogic.test.core.WorldOfOrbGame.ScreenType;
...
import com.badlogic.test.core.ui.PlayerHUD;
...
public class MainGameScreen extends GameScreen {
    ...
    public MainGameScreen(WorldOfOrbGame game){
        _game = game;
    ...
    public void render(float delta) {
        if( _gameState == GameState.GAME_OVER ){
            _game.setScreen(_game.getScreenType(ScreenType.GameOver));
        }
