package com.badlogic.test.core.screens;
...
import com.badlogic.test.core.battle.MonsterFactory;
...
import com.badlogic.test.core.gameComponents.maps.MapFactory;
...
import com.badlogic.test.core.ui.AnimatedImage;

public class CutSceneScreen extends MainGameScreen {
    private WorldOfOrbGame _game;
    ...
    public CutSceneScreen(WorldOfOrbGame game) {
        super(game);
        ...
        _switchScreenAction = new RunnableAction(){
            @Override
            public void run() {
                _game.setScreen(_game.getScreenType(WorldOfOrbGame.ScreenType.MainMenu));
            }
        };
