package com.badlogic.test.core.coreComponents.graphics;
...
import com.badlogic.test.core.gameComponents.entities.EntityConfig.AnimationConfig;
...
//Specifically for messages with 1 object payload
        if (string.length == 2) {
            if (string[0].equalsIgnoreCase(
                ...
                _currentPosition = _json.fromJson(Vector2.class,
                        string[1]);
                ...
                _currentState = _json.fromJson(Entity.State.class,
                        string[1]);
            } else if (string[0].equalsIgnoreCase(
                ...
                Array<AnimationConfig> animationConfigs =
                        entityConfig.getAnimationConfig();
                for (AnimationConfig animationConfig :
                        animationConfigs) {
                    ...
                    if (textureNames.size == 1) {
                        animation = loadAnimation(
                                textureNames.get(0), points,
                                frameDuration);
                    } else if (textureNames.size == 2) {
                        animation =
                                loadAnimation(textureNames.get(0),
                                        textureNames.get(1), points,
                                        frameDuration);
                    }
