package com.jones.libgdx.worldoforb.screens;
...
import com.jones.libgdx.worldoforb.UI.AnimatedImage;
...
import com.jones.libgdx.worldoforb.EntityFactory;
import com.jones.libgdx.worldoforb.map.Map;
import com.jones.libgdx.worldoforb.map.MapFactory;
import com.jones.libgdx.worldoforb.Utility;
import com.jones.libgdx.worldoforb.battle.MonsterFactory;
import com.jones.libgdx.worldoforb.profile.ProfileManager;

public class CutSceneScreen extends MainGameScreen {
    private WorldOfOrb _game;
    ...
    public CutSceneScreen(WorldOfOrb game) {
        super(game);
        ...
        _switchScreenAction = new RunnableAction(){
            @Override
            public void run() {
                _game.setScreen(_game.getScreenType(WorldOfOrb.ScreenType.MainMenu));
            }
        };
