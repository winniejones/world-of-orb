...
import com.badlogic.test.core.audio.AudioManager;
import com.badlogic.test.core.audio.AudioObserver;
import com.badlogic.test.core.audio.AudioSubject;
import com.badlogic.test.core.battle.BattleObserver;
import com.badlogic.test.core.coreComponents.Component;
import com.badlogic.test.core.coreComponents.ComponentObserver;
import com.badlogic.test.core.dialog.ConversationGraph;
import com.badlogic.test.core.dialog.ConversationGraphObserver;
import com.badlogic.test.core.gameComponents.InventoryItem;
import com.badlogic.test.core.gameComponents.InventoryItem.ItemTypeID;
...
import com.badlogic.test.core.profile.ProfileObserver;
import com.badlogic.test.core.quest.QuestGraph;
import com.badlogic.test.core.screens.MainGameScreen;
import com.badlogic.test.core.sfx.ClockActor;
import com.badlogic.test.core.sfx.ScreenTransitionAction;
import com.badlogic.test.core.sfx.ScreenTransitionActor;
import com.badlogic.test.core.sfx.ShakeCamera;
import com.badlogic.test.core.ui.StatusObserver.StatusEvent;
import com.badlogic.test.core.ui.inventory.*;
    ...
    public void onNotify(String value, ComponentEvent event) {
        switch(event) {
            case LOAD_CONVERSATION:
                ...
                if( config.getItemTypeID().equalsIgnoreCase(ItemTypeID.NONE.toString()) ) {
