...
public class MainMenuScreen extends GameScreen {
	...
	public MainMenuScreen(WorldOfOrb game){
		_game = game;
		...
		watchIntroButton.addListener(new ClickListener() {
										 ...
										 public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
											 ...
											 _game.setScreen(_game.getScreenType(WorldOfOrb.ScreenType.WatchIntro));
										 }
									 }
		);
		...
		creditsButton.addListener(new ClickListener() {
										 ...
										 @Override
										 public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
											 _game.setScreen(_game.getScreenType(WorldOfOrb.ScreenType.Credits));
										 }
									 }
		);
