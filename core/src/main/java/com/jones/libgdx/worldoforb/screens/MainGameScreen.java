...
import com.jones.libgdx.worldoforb.UI.PlayerHUD;
...
public class MainGameScreen extends GameScreen {
	...
	public MainGameScreen(WorldOfOrb game){
		_game = game;
	...
	public void render(float delta) {
		if( _gameState == GameState.GAME_OVER ){
			_game.setScreen(_game.getScreenType(WorldOfOrb.ScreenType.GameOver));
		}
